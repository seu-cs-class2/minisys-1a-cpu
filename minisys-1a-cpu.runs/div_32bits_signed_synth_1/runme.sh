...
HD_PWD='D:/minisys-1a-cpu/minisys-1a-cpu.runs/div_32bits_signed_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log div_32bits_signed.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source div_32bits_signed.tcl
