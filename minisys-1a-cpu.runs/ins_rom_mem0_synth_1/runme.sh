...
HD_PWD='D:/minisys-1a-cpu/minisys-1a-cpu.runs/ins_rom_mem0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ins_rom_mem0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ins_rom_mem0.tcl
