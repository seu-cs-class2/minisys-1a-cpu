...
HD_PWD='D:/minisys-1a-cpu/minisys-1a-cpu.runs/mul_32bits_unsigned_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mul_32bits_unsigned.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mul_32bits_unsigned.tcl
