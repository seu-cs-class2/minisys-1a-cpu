...
module cpu (
  ...
  input [`WordRange] dmem_data_in,
  output wire[`WordRange] dmem_addr_out,
  output wire dmem_e_out,
  output wire [`WordRange] dmem_store_data_out,

  output wire beep_en_out, // 0xFFFF_FD10
  output wire digits_en_out, // 0xFFFF_FC00
  output wire keyboard_en_out, // 0xFFFF_FC10
  output wire leds_en_out, // 0xFFFF_FC60
  output wire pwm_en_out, // 0xFFFF_FC30
  output wire switches_en_out, // 0xFFFF_FC70
  output wire timer_en_out, // 0xFFFF_FC20
  output wire watchdog_en_out // 0xFFFF_FC50
  ...
  wire mem_we_out;
  wire mem_e_out;
  wire mem_beep_en_out; // 0xFFFF_FD10
  wire mem_digits_en_out; // 0xFFFF_FC00
  wire mem_keyboard_en_out; // 0xFFFF_FC10
  wire mem_leds_en_out; // 0xFFFF_FC60
  wire mem_pwm_en_out; // 0xFFFF_FC30
  wire mem_switches_en_out; // 0xFFFF_FC70
  wire mem_timer_en_out; // 0xFFFF_FC20
  wire mem_watchdog_en_out; // 0xFFFF_FC50

  assign dmem_store_data_out = mem_store_data_out;
  ...
  mem  u_mem (
    ...
    .beep_en_out            (beep_en_out),
    .digits_en_out          (digits_en_out),
    .keyboard_en_out        (keyboard_en_out),
    .leds_en_out            (leds_en_out),
    .pwm_en_out             (pwm_en_out),
    .switches_en_out        (switches_en_out),
    .timer_en_out           (timer_en_out),
    .watchdog_en_out        (watchdog_en_out)
  );
